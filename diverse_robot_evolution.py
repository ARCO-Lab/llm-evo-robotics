...
def run_diverse_genetic_optimization(pop_size=10, n_gen=5, use_gui=True, verbose=False, pause_after_eval=False, save_designs=True):
    """运行多样化结构的遗传算法优化机器人设计"""
    print("\n开始遗传算法优化机器人设计...")
    ...
    try:
        ...
        problem = RobotDesignProblem(n_var=100, use_gui=use_gui, verbose=verbose, 
                                    pause_after_eval=pause_after_eval, add_diversity=True)
...
if __name__ == "__main__":
    print("多样化机器人结构进化优化")
    print("1. 使用默认参数运行多样化结构进化")
    print("2. 设置自定义参数运行多样化结构进化")
    print("3. 测试随机多样化机器人设计")
    print("4. 查看已保存的多样化机器人设计")
